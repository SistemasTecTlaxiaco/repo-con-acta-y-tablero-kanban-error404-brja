...
test("null vals okay", function () {
    expect(bigize({ cost: "0.001", cmc: null }, ["cost", "cmc"])).toEqual({
        cost: new BigNumber("0.001"),
        cmc: null,
    });
});
test("undefined vals okay", function () {
    expect(bigize({ cost: "0.001" }, ["cost", "cmc"])).toEqual({
        cost: new BigNumber("0.001"),
    });
});
test("multilevel obj", function () {
    expect(bigize({ cost: "0.001", cmc: "0.04", color: { cost: "0.001", cmc: "0.04" } }, ["cost", "cmc"])).toEqual({
        cost: new BigNumber("0.001"),
        cmc: new BigNumber("0.04"),
        color: { cost: new BigNumber(0.001), cmc: new BigNumber(0.04) },
    });
});
test("Don't choke if something is already bigged", function () {
    expect(bigize({
        cost: "0.001",
        cmc: new BigNumber("0.04"),
...
//# sourceMappingURL=bigize.test.js.map