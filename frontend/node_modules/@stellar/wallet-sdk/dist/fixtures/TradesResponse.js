export var TradesResponsePartialFill = {
    _links: {
        self: {
            href: "https://horizon.stellar.org/accounts/PHYREXIA/trades?cursor=" +
                "\u0026limit=10\u0026order=desc",
        },
        next: {
            href: "https://horizon.stellar.org/accounts/PHYREXIA/trades?cursor=" +
        ...
        records: [
            {
                ...
                counter_asset_issuer: "GBDEVU63Y6NTHJQQZIKVTC23NWLQVP3WJ2RI2OTSJTNYOIGICST6DUXR",
...
export var TradesResponseFullFill = {
    _links: {
        self: {
            href: "https://horizon.stellar.org/accounts/PHYREXIA/trades?cursor=" +
                "\u0026limit=10\u0026order=desc",
...
//# sourceMappingURL=TradesResponse.js.map