...
it("makes offers from partial fill", function () {
    var tradeResponse = parseResponse(TradesResponsePartialFill);
    var offers = makeDisplayableOffers({ publicKey: "PHYREXIA" }, {
...
//# sourceMappingURL=makeDisplayableOffers.test.js.map