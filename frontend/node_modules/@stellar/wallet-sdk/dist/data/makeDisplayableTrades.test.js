...
it("makes trades from real-world examples", function () {
    var trades = makeDisplayableTrades({ publicKey: "PHYREXIA" }, parseResponse(TradesResponsePartialFill).records);
...
//# sourceMappingURL=makeDisplayableTrades.test.js.map