...
export interface TransferResponse {
    type: TransferResponseType.ok | TransferResponseType.non_interactive_customer_info_needed | TransferResponseType.interactive_customer_info_needed | TransferResponseType.customer_info_status | TransferResponseType.error;
    id?: string | number;
    error?: string;
    url?: string;
}
...
interface BaseTransaction {
    id: string;
    status: TransactionStatus.incomplete | TransactionStatus.pending_user_transfer_start | TransactionStatus.pending_user_transfer_complete | TransactionStatus.pending_external | TransactionStatus.pending_anchor | TransactionStatus.pending_stellar | TransactionStatus.pending_trust | TransactionStatus.pending_user | TransactionStatus.completed | TransactionStatus.refunded | TransactionStatus.no_market | TransactionStatus.too_small | TransactionStatus.too_large | TransactionStatus.error;
    status_eta?: number;
...
export interface WatchOneTransactionParams extends TransactionParams, WatcherParams<Transaction> {
