      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.warn('trezor-connect version 8 has been deprecated. Please start using @trezor/connect version 9 https://www.npmjs.com/package/@trezor/connect');
...
var renderWebUSBButton = function renderWebUSBButton(className) {
  (0, _button["default"])(className, _settings.webusbSrc);
};
